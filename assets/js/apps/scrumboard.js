    ...
    */
    ...
    function $_taskSortable() {
        $('[data-sortable="true"]').sortable({
            ...
            stop: function( event, ui ) {
                ...
                var $itemEditado = $(ui.item);
                console.log($itemEditado.data("title"));
                console.log($itemEditado.data("id"));
                
                var $padre = $itemEditado.parents(".columnTask");
                console.log("INDEX: "+$padre.data("index"));
                console.log("NAME: "+$padre.data("name"));
                
                setTaskStatus($itemEditado.data("id"), $padre.data("index"), $padre.data("name"));
    ...
    function addTask() {
        $('.addTask').on('click', function(event) {
            ...
            $("#txtEstadoTicket").val(status);
            $("#crearTicketEstado").html(status);
            $("#crearTicketEstado").css('color',color);
            $("#crearTicketEstado").css('background-color',hex2rgba(color, 0.4));
            $("#ModalCrearTarea").modal();
        });
    }
