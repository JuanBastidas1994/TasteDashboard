    ...
    fetch(`${ApiUrl}/ordenes`,{
        ...
        .then(response => {
            ...
            if(response.success == 1){
                ...
                console.log("NUEVA BUSQUEDAAAA",data);
    ...
    fetch(`${ApiUrl}/ordenes/asignar`,{
        ...
        .then(response => {
            ...
            if(response.success == 1){
                ...
                facturar_inventario(order_id);
                if (window.openRecipientes) {
                    openRecipientes(order_id, event);
                }
            }else{
    ...
    fetch(`${ApiUrl}/ordenes/cancelar-courier`,{
        ...
        .then(response => {
            ...
            if(response.success == 1){
                ...
                openOrden(order_id);
                notify(response.mensaje, "success", 2);
                anular_facturar_inventario(order_id);
            }else{
                messageDone(response.mensaje,'error');
            }
        })
