...
$("body").on("click", ".btnAddCred", function(){
    $("#modalCredito").modal();
});

$("body").on("click", "#btnAgregarCredito", function(){
    let urlParams = new URLSearchParams(window.location.search);
    let credito = $("#txtAddCredito").val();
    let cod_usuario = urlParams.get("id");

    if(credito == ""){
        messageDone("Ingrese cantidad a acreditar", "error");
        return;
    }
    ...
    $.ajax({
        url:'controllers/controlador_usuario.php?metodo=setCredito',
        data,
        type: "POST",
        headers: {
