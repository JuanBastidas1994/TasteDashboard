$(document).ready(function() {
    $("#btnGuardar").on("click",function(event){
          ...
          $.ajax({
              ...
              url: 'controllers/controlador_categorias.php?metodo=crear',
              type: 'POST',
              data: formData,
              contentType: false,
              processData: false,
    ...
    $("#btnEliminar").on("click",function(){
        ...
        messageConfirm('¿Estas seguro de eliminar esta categoria?', 'No se puede revertir los cambios', "warning")
        .then(function(result) {
            if (result) {
                var parametros = {
              "cod_categoria": id,
    ...
    function ordenarItems(data){
	  ...
	  $.ajax({
	      url:'controllers/controlador_categorias.php?metodo=actualizar',
	      type:'POST',
	      data:parametros,
	      success:function(response){
	        console.log(response);
