$(document).ready(function() {
    ...
    $(".btnEditar").on("click",function(event){
        ...
        $.ajax({
              ...
              url: 'controllers/controlador_helpdesk.php?metodo=get',
              type: 'GET',
              data: parametros,
     ...
     function eliminar(id){
          ...
          $.ajax({
              ...
              url: 'controllers/controlador_helpdesk.php?metodo=set_estado',
              type: 'GET',
              data: parametros,
              success: function(response){
                  console.log(response);
    ...
    $("#btnGuardar").on("click",function(event){
          ...
          if(id > 0){
              formData.append('cod_helpdesk', id);
          }
          ...
          $.ajax({
              ...
              url: 'controllers/controlador_helpdesk.php?metodo=crear',
              type: 'POST',
              data: formData,
              contentType: false,
              processData: false,
    ...
    function ordenarItems(data){
	  ...
	  $.ajax({
	      url:'controllers/controlador_helpdesk.php?metodo=actualizar',
	      type:'POST',
	      data:parametros,
	      success:function(response){
	        console.log(response);
