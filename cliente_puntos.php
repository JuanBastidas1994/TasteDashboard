...
<body>
    ...
    <div class="main-container" id="container">
                        ...
                        <div class="row">
                            <div class="col-12  layout-spacing">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="other-tab" data-toggle="tab" href="#other" role="tab" aria-controls="other" aria-selected="false">Otros créditos</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="other" role="tabpanel" aria-labelledby="other-tab">
                                        <div class="table-responsive" id="table-other-credits">
                                            <div class="table-responsive" id="table-other-credits">
                                                <!-- TEMPLATE ID: other-credits-template -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script src="assets/js/pages/cliente_puntos.js" type="text/javascript"></script>
