                                                ...
                                                $resp = $Clempresas->getFormasPagoEmp($session['cod_empresa']);
                                                  foreach ($resp as $forma) {
                                                    ...
                                                    <tr data-id="'.$forma['cod_empresa_forma_pago'].'">
                                                        <td class="text-center" >
                                                           <input type="text" id="txt_nombre'.$forma['id_forma_pago'].'" class="form-control" style="text-align: center;"
                                                        value="'.$forma['fp_desc'].'" disabled>
                                                        
                                                           <input type="hidden" id="txt_descripcion'.$forma['cod_empresa_forma_pago'].'" class="form-control" style="text-align: center;"
                                                        value="'.$desc_larga.'" >
                                                        </td>
                                                        <td class="text-center">
                                                        ...
                                                        <td class="text-center"><button type="button" class="btn btn-outline-primary btnDescripcion" data-id="'.$forma['cod_empresa_forma_pago'].'">Ingresar Descripcion</button></td>
