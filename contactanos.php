...
<body>
    <div class="contact-us">
        <div class="cu-contact-section">                           
            <div class="cu-section-header">
                ...
                <p> Envíe sus consultas y le responderemos <br/> a usted lo antes posible.</p>
            </div>
            <div id="basic_map1"></div>
            <div class="contact-form">
                <form class="">
                    <h4>Env&iacute;anos un mensaje</h4>
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 col-12">
                            <p class="">M&eacute;todo de comunicaci&oacute;n preferido</p>
                        </div>
                        <div class="col-sm-12 col-12 input-fields">
                            <div class="n-chk">
                            ...
                            <div class="n-chk">
                                <label class="new-control new-radio radio-primary">
                                  <input type="radio" class="new-control-input" name="custom-radio-1" checked="">
                                  <span class="new-control-indicator"></span>Tel&eacute;fono
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function initMap() {
            var myLatLng = {lat: -2.15602105, lng: -79.89062837414613};
