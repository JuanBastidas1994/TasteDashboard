...
if(isset($_GET['id'])){
  ...
  if($orden){
    ...
    $direccion = $orden['calle'].' '.$orden['manzana_villa'];
    $correo = $orden['correo'];
    $fecha = fechaCastellano2($orden['fecha']);
    ...
    $total = number_format($orden['total'],2);
      ...
      if($orden['pago']=="TB")
        ...
        $pago = "Bot&oacute;n de Pagos - Pagado";
      else if($orden['pago']=="E"){
        if($orden['is_suelto'] == 1){
          $pago = "Efectivo";
          $pagoDetalle = ', Se enviar&aacute; suelto de $'.number_format($orden['monto_suelto'],2);
        }
      }
    ...
    /*$redesSociales = $Clempresas->getRedesSociales($cod_empresa);
                 ...
                 <tr style="border-collapse:collapse"> 
                  <td valign="top" align="center" style="padding:0;Margin:0;width:560px"> 
                   <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:center bottom" role="presentation"> 
                     <tr style="border-collapse:collapse"> 
                      <td class="es-m-txt-c" align="center" style="padding:0;Margin:0;font-size:0px"><a href="https://danilorestaurante.com/" target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;font-size:14px;text-decoration:underline;color:#FFFFFF"><img src="https://itouxr.stripocdn.email/content/guids/d4607f0f-36ba-4644-9860-1242371f6115/images/4691595159379167.png" alt="Hummingbird logo" title="Hummingbird logo" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="138"></a></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
                        ...
                        <table width="100%">';
                          ...
                          foreach ($resp as $detalle) {
                            ...
                            if($detalle['descripcion']!=""){
                              ...
                              $imagen = $files.$detalle['image_min'];
                              $html .= '<tr>
                                    <td style="width: 50px;">
                          ...
                          <tr>
                            <td colspan="4"><p style="margin: 10px 0px 0px 0px; font-size: 12px;">Forma de Pago: '.$pago.' '.$pagoDetalle.'</p></td>
                          </tr>
                          <tr>
