...
if(isset($_GET['emp'])){
    ...
    $numPruebas = $_POST['txt_numPruebas'];
    $tipoPrueba = $_POST['cmbTipoPrueba'];
    $fecha_cita = fechaLatinoShort($_POST['fechaCita']);
}
                 ...
                 <tr style="border-collapse:collapse"> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-bottom:5px"><h1 style="Margin:0;line-height:38px;mso-line-height-rule:exactly;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;font-size:32px;font-style:normal;font-weight:bold;color:#4A4A4A">Cita</h1></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px"> 
                        ...
                        <table width="100%">
                          ...
                          <tr>
                            <td style="width: 50px;">
                              <strong>Email: </strong>'.$telefono_r.'
                            </td>
                          </tr>
                          <tr>
                            <td style="width: 50px;">
                          ...
                          <tr>
                            <td style="width: 50px;">
                              <strong>N&uacute;mero de pruebas: </strong>'.$numPruebas.'
                            </td>
                          </tr>
                          <tr>
                            <td style="width: 50px;">
                              <strong>Tipo de pruebas: </strong>'.$tipoPrueba.'
                            </td>
                          </tr>
                          <tr>
                            <td style="width: 50px;">
                              <strong>Fecha de la cita: </strong>'.$fecha_cita.'
                            </td>
                          </tr>
                        </table>
...
if(isset($_GET['print'])){
  ...
  try {
      ...
      $mail->addAddress('josuesanti17@gmail.com', html_entity_decode($nombre)); //morogrill@gmail.com
      ...
      else
      {
        ...
        $return['correo'] = "josuesanti17@gmail.com"; //morogrill@gmail.com
      }
    } catch (Exception $e) {
      $return['success']= 0;
        $return['mensaje']= "Error al enviar el correo";
