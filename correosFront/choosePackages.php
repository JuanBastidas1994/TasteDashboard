...
//EMPRESA
$name = "Luisa Mosquera Photography";
$web = "https://luisamosquera.com/";
$logo = $web."style/images/pages/logo.png";
$bgcolor = "#000";
$mailto = "luisamosquera.photography@outlook.com";
// $mailto = "josue.digitalmind@gmail.com";
$setFrom = "info@mie-commerce.com";

//PACKAGE
$textTitle = "Package Information"; $_GET['title'];
$nombre_r = $_GET['nombre'];
$telefono_r = $_GET['phone'];
$correo_r = $_GET['email'];
$fecha_r = fecha_only();
...
if(!is_null($_GET['subject']) && !is_null($_GET['message'])){
                 ...
                 <tr style="border-collapse:collapse"> 
                  <td valign="top" align="center" style="padding:0;Margin:0;width:560px"> 
                   <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:center bottom" role="presentation"> 
                     <tr style="border-collapse:collapse"> 
                      <td class="es-m-txt-c" align="center" style="padding:0;Margin:0;font-size:0px"><a href="'.$web.'" target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;font-size:14px;text-decoration:underline;color:#FFFFFF"><img src="'.$logo.'" alt="'.$name.'" title="'.$name.'" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="80"></a></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
                 ...
                 <tr style="border-collapse:collapse"> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-bottom:5px"><h1 style="Margin:0;line-height:38px;mso-line-height-rule:exactly;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;font-size:32px;font-style:normal;font-weight:bold;color:#4A4A4A">'.$textTitle.'</h1></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px"> 
                        ...
                        <table width="100%">
                          <tr>
                            <td style="width: 50px;">
                              <strong>Name: </strong>'.$nombre_r.'
                            </td>
                            <td style="width: 50px; <?=$displayTel?>">
                              <strong>Phone: </strong>'.$telefono_r.'
                            </td>
                          </tr>
                          <tr>
                            <td style="width: 50px;">
                              <strong>Email: </strong>'.$correo_r.'
                            </td>
                            <td style="width: 50px;">
                              <strong>Date: </strong>'.$fecha_r.'
                            </td>
                          </tr>
                          '.$camposExtras.'
                        </table>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                 <tr style="border-collapse:collapse"> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td align="center" class="es-m-txt-l" style="padding:0;Margin:0;padding-top:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;line-height:21px;color:#4A4A4A"></p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
...
if(isset($_GET['print'])){
  ...
  try {
      ...
      $mail->addAddress($mailto, html_entity_decode($nombre));
      $mail->addReplyTo($correoReplyTo, $name);
      // $mail->addCC('josue.digitalmind@gmail.com');
