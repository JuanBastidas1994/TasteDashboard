                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px"> 
                        ...
                        <table width="100%">
                          <tr>
                            <td>
                              <strong style="margin-top: 40px;">Nombre: </strong>'.$nombre_r.'
                            </td>
                          </tr>
                          <tr>
                            <td style="<?=$displayTel?>">
                              <br>
                              <strong style="margin-top: 40px;">Tel&eacute;fono: </strong>'.$telefono_r.'
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <br>
                              <strong style="margin-top: 40px;">Email: </strong>'.$correo_r.'
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <br>
                              <strong style="margin-top: 40px;">fecha: </strong>'.$fecha_r.'
                            </td>
                          </tr>
                          <tr style="padding-top: 40px;">
                            <td>
                              <br>
                              <strong>Comentarios: </strong> <br> '.$comentarios_r.'
                            </td>
                          </tr>
                        </table>
