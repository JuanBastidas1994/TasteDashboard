...
if(isset($_GET['emp'])){
    ...
    $telefono_r = $_GET['telefono'];
    $correo_r = $_GET['correo'];
    $zip_r = $_GET['zip'];
    $fecha_r = fecha_only();
    $comentarios_r = $_GET['comentarios'];
                 ...
                 <tr style="border-collapse:collapse"> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-bottom:5px"><h1 style="Margin:0;line-height:38px;mso-line-height-rule:exactly;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;font-size:32px;font-style:normal;font-weight:bold;color:#4A4A4A">Contact</h1></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px"> 
                        ...
                        <table width="100%">
                          ...
                          <tr>
                            <td style="width: 50px;">
                              <strong>Zip code: </strong>'.$zip_r.'
                            </td>
                          </tr>
                          <tr>
                            <td style="width: 50px;">
                              <strong>Message: </strong>'.$comentarios_r.'
                            </td>
                          </tr>
                        </table>
