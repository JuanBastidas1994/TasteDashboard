  ...
  if($orden){
    ...
    foreach($pagos as $pg){
        ...
        if($pg['forma_pago'] == "T"){
            ...
            $auth = "";
            if($pg['observacion2'] <> "")
                $auth = "<p style=\"margin: 10px 0px 0px 0px; font-size: 12px;\">Tu n&uacute;mero de autorizaci&oacute;n es: ".$pg['observacion2']."</p>";
        }
    }           
    if($orden['is_suelto'] == 1)
        $textPagos.= "Se enviar&aacute; suelto de $".number_format($orden['monto_suelto'],2);
