...
if(isset($_GET['emp'])){
    ...
    //RESERVACION
    $nombre_r = $_POST['txt_nombre'];
    $telefono_r = $_POST['txt_telefono'];
    $correo_r = $_POST['txt_correo'];
    $personas_r = $_POST['txt_personas'];
    $fecha_r = fechaLatinoShort($_POST['txt_fecha']);
    $comentarios_r = $_POST['txt_comentarios'];
    $sucursal_r = $_POST['cmb_sucursales'];
}
                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px"> 
                        ...
                        <table width="100%">
                          <tr>
                            <td style="width: 50px;">
                              <strong>Nombre: </strong>'.$nombre_r.'
                            </td>
                            <td style="width: 50px;">
                              <strong>Tel&eacute;fono: </strong>'.$telefono_r.'
                            </td>
                          </tr>
                          <tr>
                            <td style="width: 50px;">
                            ...
                            <td style="width: 50px;">
                              <strong>Personas: </strong>'.$personas_r.'
                            </td>
                          </tr>
                          <tr>
                            <td style="width: 50px;">
                              <strong>fecha: </strong>'.$fecha_r.'
                            </td>
                            <td style="width: 50px;">
                              <strong>Sucursal: </strong>'.$sucursal_r.'
                            </td>
                          </tr>
                          <tr>
                            <td style="width: 50px;">
                              <strong>Comentarios: </strong>'.$comentarios_r.'
                            </td>
                          </tr>
                        </table>
...
if(isset($_GET['print'])){
  ...
  try {
      ...
      $mail->addAddress('morogrill@gmail.com', html_entity_decode($nombre)); //morogrill@gmail.com josue.digitalmind@gmail.com 
      ...
      else
      {
        ...
        $return['correo'] = "morogrill@gmail.com"; //morogrill@gmail.com josue.digitalmind@gmail.com
      }
    } catch (Exception $e) {
      $return['success']= 0;
      $return['mensaje']= "Error al enviar el correo";
