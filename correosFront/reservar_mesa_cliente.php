                 ...
                 <tr style="border-collapse:collapse"> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-bottom:5px"><h1 style="Margin:0;line-height:38px;mso-line-height-rule:exactly;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;font-size:32px;font-style:normal;font-weight:bold;color:#4A4A4A">Reservaci&oacute;n</h1></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px"> 
                        ...
                        <table width="100%">
                          <tr>
                            <td style="width: 50px;">
                                Muchas gracias por agendar tu reserva con nosotros, enseguida verificamos los datos para validar la información. Confirmaremos tu reserva respondiendo este correo o llam&aacute;ndote a tu celular.<br>
                            </td>
                          </tr>
                          <tr><td>&nbsp;</td></tr>
                          <tr>
                            <td style="width: 50px;">
                                IMPORTANTE: Si tu reserva es confirmada, tienes que saber que debes llegar 15 minutos antes de la hora pactada y la reserva se hace v&aacute;lida con todos los participantes presentes.<br>
                            </td>
                          </tr>
                          <tr><td>&nbsp;</td></tr>
                          <tr>
                            <td style="width: 50px;">
                                Para cualquier duda e informaci&oacute;n recuerda que tambi&eacute;n puedes llamarnos o escribirnos al n&uacute;mero (+593) 0963748655 o visitar nuestras redes sociales Instagram, Facebook y Twitter como @morogrill.<br>
                            </td>
                          </tr>
                          <tr><td>&nbsp;</td></tr>
                          <tr>
...
if(isset($_GET['print'])){
  ...
  try {
      ...
      $mail->addAddress($correo_r, html_entity_decode($nombre));
