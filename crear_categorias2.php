...
if(isset($_GET['id'])){
  ...
  if($Clcategorias->getArrayByAlias($alias, $producto)){
    ...
    $categoriasPadres = $Clcategorias->getVariasCategorias($cod_producto);
    //var_dump($categoriasPadres);
  }else{
    header("location: ./index.php");
  }    
}

function getCombo($id, $cod_empresa, $nivel=1, $values=[]){
    $html = "";
    $lvl = "l".$nivel; 
...
<body>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8 col-sm-8 col-xs-12" style="<?= $displayCombo ?>">
                                        ...
                                        <select multiple="multiple" name="cmb_categoria[]" id="cmb_categoria" class="form-control" required="required">
                                            ...
                                            <?php
                                              echo getCombo(0, $session['cod_empresa'], 1, $categoriasPadres);
                                            ?>
                                        </select>
                                    </div>
    ...
    <?php js_mandatory(); ?>
    <script src="assets/js/pages/crear_categorias2.js" type="text/javascript"></script>
