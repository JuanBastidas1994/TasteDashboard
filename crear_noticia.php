...
<body>
  <div class="modal fade bs-example-modal-lg" id="modalCroppie" tabindex="99" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
                              ...
                              <div class="x_content">   
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class="upload mt-1 pr-md-1">
                                        <input type="file" name="img_product" id="dropifyPerfil" class="dropify" data-default-file="<?php echo $imagen; ?>" data-max-file-size="6M" data-allowed-file-extensions="jpeg jpg png"/>
                          ...
                          <form id="frmUploadImg" method="POST" action="#">
                            <div class="row"> 
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12 respGalery" style="margin-top: 20px;">
                                ...
                                <?php
                                  if($cod_noticia != 0){
                                    $respGaleria = $Clnoticias->lista_imagenes($cod_noticia);
    ...
    <?php js_mandatory(); ?>
    <script src="assets/js/pages/crear_noticias.js?v=4" type="text/javascript"></script>
