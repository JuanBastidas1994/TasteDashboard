...
<body>
            ...
            <div class="layout-px-spacing">
                <div class="col-md-12" style="margin-top:25px; ">
                    <div><span id="btnBack" data-module-back="promociones.php" style="cursor: pointer;">
                            <i data-feather="chevron-left"></i><span style="font-size: 16px; vertical-align: middle;color:#888ea8;">Promociones Avanzadas</span></span>
                    </div>
                    <h3 id="titulo"><?php echo ($descripcion != "") ? $descripcion : "Agregar Promoción Avanzada"; ?></h3>
                    ...
                    <div class="col-xl-7 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="widget-content widget-content-area br-6" style="margin-top: 15px;">
                            <form id="frmProductos" method="POST" action="#">
                                <div id="contentXporY" class="contentCondicion">
                                    <div class="">
                                        <h4>Productos Participantes</h4>
                                        <p>Escoje los productos que el cliente debe comprar para tener 1 o varios productos gratis</p>
                                    </div>
                                    <div class="row">
                                ...
                                <div id="contentMontoMinimo" class="contentCondicion" style="display: none;">
                                    <div class="">
                                        <h4>Monto mínimo</h4>
                                        <p>Ingresa el valor del monto que debe comprar el cliente sin envío para llevarse un producto gratis</p>
                                    </div>
                                    <div>
                                        <label for="">Monto mínimo de compra</label>
                    ...
                    <div class="col-xl-5 col-lg-12 col-sm-12  layout-spacing">
                        ...
                        <div class="widget-content widget-content-area br-6">
                            ...
                            <form id="frmDisponibilidad" method="POST" action="#">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        <label>Condición <span class="asterisco">*</span></label>
                                        <select class="form-control" name="cmb_condicion" id="cmb_condicion">
                                                <option value="0" <?php if($is_porcentaje == 1) echo 'selected'; ?> >Compra X lleva Y</option>
    ...
    <script src="assets/js/pages/crear_promociones_advanced.js?v=995" type="text/javascript"></script>
