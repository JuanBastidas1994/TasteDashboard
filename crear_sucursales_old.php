            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    ...
                    <div class="alert alert-arrow-right alert-icon-right alert-light-danger mb-4" role="alert" style="display:none;">
                        ...
                        <strong>Advertencia!</strong> El permiso de ubicaci&oacute;n esta apagado, si quieres una mejor experiencia de usuario habilita esta funcion para que el sistema detecte tu ubicaci&oacute;n
                    </div>
