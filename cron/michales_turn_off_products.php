...
$cod_empresa = 171; // ROLL IT
$cod_categoria = 1364; // CATEGORÍA ROLL IT LUNCH
...
$file = $folder."/michaels_turn_on_off_products.log";
$fecha = fecha();
$log = "[$fecha] Se ejecutó el cronjob estado de los productos: $estado";
