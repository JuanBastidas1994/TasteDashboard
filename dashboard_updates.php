        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">CREAR FAQ</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                    </button>
                </div>
                              ...
                              <select id="cmb_faq" name="cmb_faq" class="form-control">
                                ...
                                <?php 
                                    ...
                                    foreach ($tipos as $tipo) {
                                        echo '<option value="'.$tipo['cod_tipo_empresa'].'">'.$tipo['tipo'].'</option>';
                                    }
                                ?>                              
                              </select>
                          </div>
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-4 col-4 text-right">
                                    <a href="crear_dashboard_updates.php" target="_blank" class="btn btn-primary">Nuevo item</a>
                                </div>
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <hr/>
                                </div>
                            ...
                            <table id="style-3" class="table style-3 table-hover dt-responsive">
                              <!--  <table class="table style-3 table-hover dt-responsive">-->
                                        ...
                                        <tbody>
                                            <?php
                                            $resp = $Clupdates->lista();
                                            foreach ($resp as $update) {
                                                $video = $update['video'];
                                                $badge='primary';
                                                if($update['estado'] == 'I')
                                                    $badge='danger';
                                                echo '<tr id="'.$update['cod_update'].'"  data-codigo="'.$update['cod_update'].'">
                                                    <td>'.$update['titulo'].'</td>
                                                    <td>'.$update['desc_corta'].'</td>
                                                    <td class="text-center"><span class="shadow-none badge badge-'.$badge.'">'.getEstado($update['estado']).'</span></td>
                                                    <td class="text-center">
                                                        <ul class="table-controls">
                                                            <li><a href="crear_dashboard_updates.php?id='.$update['cod_update'].'" data-value="'.$update['cod_update'].'" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i data-feather="edit-2"></i></a></li>
                                                            <li><a href="javascript:void(0);" data-value="'.$update['cod_update'].'" class="bs-tooltip btnEliminar" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i data-feather="trash"></i></a></li>
                                                        </ul>
                                                    </td>
                                                </tr>';
                                            }
