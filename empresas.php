                                                ...
                                                echo '<tr>
                                                    ...
                                                    <td class="text-center">
                                                        <ul class="table-controls">
                                                            ...
                                                            <li><a data-web="'.$empresa['url_web'].'" data-value="'.$categoria['alias'].'" data-folder="'.$empresa['folder'].'" href="javascript:void(0);" class="bs-tooltip btnMore" data-toggle="tooltip" data-placement="top" title="Más" data-original-title="Más"><i data-feather="more-horizontal"></i></a></li>
