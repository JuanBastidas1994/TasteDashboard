...
$ClLaar = new cl_laar(NULL);
$ClPicker = new cl_picker(NULL);
                                        ...
                                        <?php
                                            ...
                                            foreach ($couriers as $courier) {
                                                ...
                                                echo '  <li class="nav-item ml-2 mr-2">
                                                            <a class="nav-link mb-2 text-center" id="rounded-pills-icon-home-tab" data-toggle="pill" href="#rounded-pills-icon-'.strtolower($nombreBoton).'" role="tab" aria-controls="rounded-pills-icon-'.strtolower($nombreBoton).'" aria-selected="true">
