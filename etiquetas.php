                                    ...
                                    <tbody id="contentCategorias" class="connectedSortable">
                                      <?php
                                        $query = "SELECT DISTINCT pt.tag 
                                                    FROM tb_productos_tags pt, tb_productos p
                                                    WHERE pt.cod_producto = p.cod_producto
                                                    AND p.cod_empresa = ".$session['cod_empresa'];    
                                        $resp = Conexion::buscarVariosRegistro($query);
                                        foreach ($resp as $p){
                                           echo '
                                              <tr>
                                                ...
                                                <td>'.$p['tag'].'</td>
                                                <td>
                                                  <a href="javascript:void(0);" data-value="'.$p['tag'].'"  class="bs-tooltip btnEliminarOpciones" data-toggle="tooltip" data-placement="top" title="" data-original-title="Quitar de la categor&iacute;a"><i data-feather="x"></i></a>
                                                </td>
                                              </tr>';
                                        }
                                        ?>
