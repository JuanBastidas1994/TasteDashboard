                        ...
                        <div class="widget-content widget-content-area br-6">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-4 col-4 text-right">
                                    <a href="crear_faq.php" target="_blank" class="btn btn-primary">Nuevo item</a>
                                </div>
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <hr/>
                                </div>
                              ...
                              <!--  <table class="table style-3 table-hover dt-responsive">-->
                                        ...
                                        <tbody id="lstBanners" class="connectedSortable">
                                            ...
                                            foreach ($resp as $faq) {
                                                ...
                                                if($faq['estado'] == 'I')
                                                    $badge='danger';
                                                echo '<tr id="'.$faq['cod_faq'].'"  data-codigo="'.$faq['cod_faq'].'">
                                                    <td>'.$faq['titulo'].'</td>
                                                    <td>'.$faq['desc_corta'].'</td>
                                                    <td>'.$faq['posicion'].'</td>
                                                    <td class="text-center"><span class="shadow-none badge badge-'.$badge.'">'.getEstado($faq['estado']).'</span></td>
                                                    <td class="text-center">
                                                        <ul class="table-controls">
                                                            <li><a href="crear_faq.php?id='.$faq['cod_faq'].'" data-value="'.$faq['cod_faq'].'" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i data-feather="edit-2"></i></a></li>
                                                            <li><a href="javascript:void(0);" data-value="'.$faq['cod_faq'].'" class="bs-tooltip btnEliminar" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i data-feather="trash"></i></a></li>
                                                        </ul>
                                                    </td>
                                                </tr>';
                                            }
