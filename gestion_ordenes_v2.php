...
/* if($session['cod_empresa'] == 144 || $session['cod_empresa'] == 140){
    header("location:gestion_ordenes_v3.php");
}
if(!isset($_GET['version'])){
    header("location:gestion_ordenes_v2.php?version=2");
} */
...
<body>
    ...
    <div class="modal fade" id="modalOrdenesAnteriores" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <?php
                        include('templates/gestion-orden-lista.html')
                    ?>
                    <div class="container">
    ...
    <div class="sub-header-container">
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <ul class="navbar-nav flex-row ml-auto ">
                <li class="bs-tooltip" data-placement="bottom" title="Notificaciones" onclick="abrirOrdenesAntiguas()">
                            ...
                            <div class="col-xl-12  col-md-12">
                                <div class="mail-box-container">
                                    ...
                                    <div id="mailbox-inbox" class="accordion mailbox-inbox">
                                        ...
                                        <?php
                                            include('templates/gestion-ordenes-orden-lista.html')
                                        ?>
                                        <div class="message-box">
    ...
    <script src="assets/js/clipboard/clipboard.min.js?v=5"></script>
    <script src="assets/js/gestion-ordenes/sounds.js?v=5" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes/index.js?v=5" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes/tracking.js?v=5" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes/mis-motorizados.js?v=5" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes/client.js?v=5" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes/office.js?v=5" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes/printers.js?v=5" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes/firebase.js?v=5" type="text/javascript"></script>
    <script src="assets/js/pages/gestion_ordenes_calendario.js?v=5" type="text/javascript"></script>
    <script src="assets/js/pages/gestion_ordenes_fidelizacion.js?v=5" type="text/javascript"></script>
    <!-- <script src="assets/js/pages/gestion_ordenes_impresion.js?v=1" type="text/javascript"></script> -->
    <script type="text/javascript" src="emoji/dist/emojionearea.js?v=5"></script>
    <link rel="stylesheet" type="text/css" href="emoji/dist/emojionearea.min.css" media="screen">
    <script src="assets/js/pages/notificaciones.js?v=5" type="text/javascript"></script>
    <script>
