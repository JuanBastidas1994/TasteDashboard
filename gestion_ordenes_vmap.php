...
if ($empresa) {
    ...
    $fidelizacion = $empresa['fidelizacion'];
...
$activeOption3 = '';
if ($hour >= 15 || $hour < 9) {
    $activeOption1 = 'active';
    $activeOption2 = '';
    $activeOption3 = '';
} elseif ($hour >= 9 && $hour < 12) {
    $activeOption1 = '';
    $activeOption2 = 'active';
    $activeOption3 = '';
} elseif ($hour >= 12 && $hour < 15) {
    $activeOption1 = '';
    $activeOption2 = '';
    $activeOption3 = 'active';
}
...
<head>
    ...
    <style type="text/css">
        ...
        #table-detail .tr-main {
            border-top: 1px solid #e0e6ed;
        }

        #table-detail .tr-main td {
        ...
        @keyframes pulse {
            ...
            50% {
                transform: scale(1.2); /* Escala el icono al 120% */
            }
            100% {
                transform: scale(1);
            }
...
<body>
    ...
    <!-- Modal Fidelizacion Burbuja-->
    <div class="modal fade bs-example-modal-sm" id="burbujaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                        ...
                        <div id="containerPip">
                            ...
                            <div class="p-2">
                                ...
                                <div id="purchaseStart">
                                    <label>Solicita la APP al cliente</label>
                                    <input type="search" class="form-control purchaseCodeInput" placeholder="ABC123" />
                                </div>
                                ...
                                <div id="purchaseClient" class="text-left" style="display:none;">
                                    ...
                                    <!--    <div>-->
                                    <!--        <button class="btn btn-primary" style="padding: 3px 8px; font-size: 12px">Continuar</button>-->
                                    <!--    </div>-->
                                    <!--    <div>-->
                                    <!--        <button class="btn btn-danger ml-2" style="padding: 3px 8px; font-size: 12px">Cancelar</button>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                ...
                <div class="modal-footer">
                    <button class="btn btnOpenBurbuja" onclick="openBurbuja()">PIP</button>
                    <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Cerrar</button>
                </div>
            </div>
        </div>
    ...
    <!-- Modal Orden Detalle-->
    <div class="modal fade bs-example-modal-xl" id="OrdenDetailModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" tabindex="-1" data-focus="false">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding-bottom: 0px !important;">
                    <?php
                    include('templates/gestion-ordenes-orden-detalle-modal-v2.html')
                    ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    ...
                    /* echo "DOCUMENT_ROOT ". $_SERVER['DOCUMENT_ROOT'];
                        echo "<br> DIR ". __DIR__; 
                        echo "existe " . file_exists(__DIR__.'/templates/gestion-orden-lista-v3.html');*/
    ...
    <div class="sub-header-container">
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <script id="office-selected" type="text/x-handlebars-template">
                ...
                {{#diferent alta_demanda false}}
                <li class="ml-3" onclick="getOfficeById()">
                    <a href="javascript:void(0)" class="badge badge-danger">
                        <i class="iconheart" data-feather="alert-triangle"></i> Alta Demanda
                    </a>
                </li>
                {{/diferent}}
                ...
                <div class="btn-group btn-group-toggle ml-3" data-toggle="buttons">
                    <label class="btn btn-outline-primary active" >
                        <input type="radio" name="vista" value="map" class="rbView" autocomplete="off" checked
                        >Mapa
                    </label>
                    <label class="btn btn-outline-primary" >
                        <input type="radio" name="vista" value="list" class="rbView" autocomplete="off"
                        >Lista
                    </label>
                </div>
            </script>
        ...
        <div id="content" class="main-content">
            <div id="bloqueZoom">
                <div class="viewItem viewMap" >
                    ...
                    <!-- Modal Asignar ordenes-->
                    <div class="modal fade" id="asignarModal" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header align-items-center">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                                    ...
                                    <h5 class="modal-title text-center" style="width: 100%;">Asignar Ordenes</h5>
                                </div>
                                <div class="modal-body" style="padding: 0px 15px;">
                                    <input type="hidden" id="orderIdAsignar" />
                                    <div id="ordenesparaasignar"></div>
                                </div>
                                <script id="ordenesparaasignar-template" type="text/x-handlebars-template">
                                    <div class="row">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mb-2 p-2">
                                                        <div class="d-flex align-items-center">
                                                            <div class="ml-2" style="cursor: pointer;">{{id}}</div>
                                                            <div class="ml-2"> {{cliente}} </div>
                                                            <div class="ml-auto">
                                                                <button class="btn btn-primary" style="background: {{color}} !important;"
                                                                    onclick="activateNewPolygon({{this}})">+</button>    
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {{/each}}
                                        ...
                                        <div class="col-6">
                                            <select class="form-control" id="cmbMotorizadoMap">
                                            {{#each motorizados}}
                                                <option value="{{id}}">
                                                    {{nombres}}
                                                </option>
                                ...
                                <div class="modal-footer">
                                    <button class="btn" data-dismiss="modal">Cerrar</button>
                                    <button class="btn btn-primary" id="btnAsignarOrdenesMasivas">Asignar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-4">
                                        <div class="text-center">
                                            <div class="btn-group btn-group-toggle mt-4" data-toggle="buttons">
                                                <label class="btn btn-outline-primary"  <?php echo ($activeOption1 ? 'active' : ''); ?>>
                                                    <input type="radio" name="options" value="10" class="rbHoras" autocomplete="off"
                                                        <?php echo ($activeOption1 ? 'checked' : ''); ?>
                                                    >Día anterior - 11:59am 
                                                </label>
                                                <label class="btn btn-outline-primary" <?php echo ($activeOption2 ? 'active' : ''); ?>>
                                                    <input type="radio" name="options" value="12" class="rbHoras" autocomplete="off"
                                                        <?php echo ($activeOption2 ? 'checked' : ''); ?>
                                                    > 12am - Resto del día
                                                </label>
                                            </div>
                                        </div>
                                        <div id="ordenesMapList" class="mt-3"></div>
    
                                        <script id="ordenesmaplist-item" type="text/x-handlebars-template">
                                            {{#each orders}}
                                            <div class="widget-content widget-content-area br-6 mb-2 p-2" onclick="openOrden({{id}})" style="cursor: pointer;">
                                                <div class="d-flex align-items-center">
                                                    <div style="background: {{color}}; width: 10px; height: 10px; border-radius: 5px;"></div>
                                                    <div class="ml-2">
                                                        <div><b>#{{id}}</b></div>
                                                        <div><b>{{nombre}}</b></div>
                                                        <div>
                                                    ...
                                                    <div class="ml-auto mr-1">
                                                        <div><b>${{total}}</b></div>
                                                        {{#eq is_express "1"}}
                                                            <div class="tagsOrderList bg-danger">
                ...
                <div class="layout-px-spacing viewItem viewList" style="display: none;">
                                ...
                                <div class="col-xl-12  col-md-12">
                                    <div class="col-xl-6 col-md-6">
                                        <div class="" style="margin-bottom:15px;text-align:left;">
                                            <input id="apikey_empresa" type="hidden" value="<?= $apikey ?>">
                                            <input id="fidelizacion_empresa" type="hidden" value="<?= $fidelizacion ?>">
                                            <input id="alias_empresa" type="hidden" value="<?= $session['alias'] ?>">
                                            ...
                                            <div class="action-center justify-content-start">
                                                ...
                                                <div class="">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        <button type="button" class="changeTipo btn btn-outline-info" data-value="onsite" style="display: <?php echo in_array("OFFICE_INSITE", $permisos) ? 'initial' : 'none'; ?>;">En Mesa</button>
                                                    </div>
    ...
    <script>
        ...
        Handlebars.registerHelper('removeUnicode', function(string) {
            const search = ['u00c1', 'u00e1', 'u00c9', 'u00e9', 'u00cd', 'u00ed', 'u00d3', 'u00f3', 'u00da', 'u00fa', 'u00d1', 'u00f1', 'u00bf'];
            const replace = ['A', 'a', 'E', 'e', 'I', 'i', 'O', 'o', 'U', 'u', 'N', 'n', ''];

            search.forEach((char, index) => {
                string = string.replace(new RegExp(char, 'g'), replace[index]);
            });
    ...
    <!-- <script src="https://unpkg.com/@googlemaps/marker-clusterer@1.2.0/dist/index.umd.js"></script> -->
    ...
    <script src="assets/js/gestion-ordenes-vmap/mis-motorizados.js" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes-vmap/client.js" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes-vmap/office.js" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes-vmap/printers.js?v=7" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes-vmap/firebase.js?v=7" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes-vmap/cierre-diario.js?v=7" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes-vmap/ordenes-programadas.js" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes-vmap/autoasignar.js?v=7" type="text/javascript"></script>

    <script src="assets/js/gestion-ordenes-vmap/fidelizacion/index.js?v=7" type="text/javascript"></script>
    <script src="assets/js/gestion-ordenes-vmap/fidelizacion/pip.js?v=7" type="text/javascript"></script>

    <script src="assets/js/gestion-ordenes-vmap/mapa/mapa.js?v=7" type="text/javascript"></script>
    ...
    <script>
        ...
        // bc.onmessage = (event) => {
        //     // Si alguien pregunta si hay gestion_ordenes activa
        //     if (event.data === "hay-alguien-ahi?") {
        //         bc.postMessage("gestion_ordenes_activa");
        //     }
        
        //     // Si otra pestaña de gestion_ordenes ya está abierta
        //     if (typeof event.data === "number" && event.data !== idGO) {
        //         messageDone('Ya se está ejecutando una instancia de este sitio', 'error');
        //         window.location = "index.php"; // o a donde quieras redirigir
        //     }
        // };
        
        // // Anunciar que esta pestaña tiene el control de gestion_ordenes
        // bc.postMessage("gestion_ordenes_activa");
        // bc.postMessage(idGO);
    </script>
</body>
