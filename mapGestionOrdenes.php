...
if($empresa){
    ...
    $motorizados = $Clusuarios->lista_motorizadosByEmpresa($cod_empresa);
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="padding: 0px 15px;">
                                <div class="row">
                                    ...
                                    <!-- Asignar -->
                                    <div class="col-6">
                                        <input type="text" id="orderIdAsignar" />
                                        <select class="form-control" id="cmbMotorizado">
                                        <?php
                                        foreach($motorizados as $motorizado){
                                            echo '<option value="'.$motorizado['cod_usuario'].'">'.$motorizado['nombre'].' '.$motorizado['apellido'].'</option>';
                                        }
                                        ?>
                                        </select>
                                    </div>
                            ...
                            <div class="modal-footer">
                                <button class="btn" data-dismiss="modal">Cerrar</button>
                                <button class="btn btn-primary" data-dismiss="modal">Asignar</button>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="text-center">
                                        <div class="btn-group btn-group-toggle mt-2" data-toggle="buttons">
                                            <label class="btn btn-outline-primary"  <?php echo ($activeOption1 ? 'active' : ''); ?>>
                                                <input type="radio" name="options" value="3" class="rbHoras" autocomplete="off"
                                                    <?php echo ($activeOption1 ? 'checked' : ''); ?>
                                                >3pm - 9am 
                                            </label>
                                            <label class="btn btn-outline-primary" <?php echo ($activeOption2 ? 'active' : ''); ?>>
                                                <input type="radio" name="options" value="9" class="rbHoras" autocomplete="off"
                                                    <?php echo ($activeOption2 ? 'checked' : ''); ?>
                                                > 9am - 12pm
                                            </label>
                                            <label class="btn btn-outline-primary" <?php echo ($activeOption3 ? 'active' : ''); ?>>
                                                <input type="radio" name="options" value="12" class="rbHoras" autocomplete="off"
                                                    <?php echo ($activeOption3 ? 'checked' : ''); ?>
                                                > 12pm - 3pm
                                            </label>
                                        </div>
                                    </div>
