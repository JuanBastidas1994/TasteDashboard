                ...
                <form id="frmSave" name="frmSave" class="form-horizontal form-label-left">    
                    <div class="x_content">    
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-4 col-sm-4 col-xs-12" style="margin-bottom:10px;">
                              <label>Placa <span class="asterisco">*</span></label>
                              <input type="text" placeholder="Placa" name="txt_placa" id="txt_placa" class="form-control" required="required" autocomplete="off"/>
                          </div>

                          <div class="col-md-4 col-sm-4 col-xs-12 input-group" style="margin-bottom:10px; display:none;">
