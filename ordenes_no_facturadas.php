...
<body>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-12 align-items-end d-flex">
                                        <button class="btn btn-primary" onclick="getOrdenesNoFActuradas();">Buscar</button>
                                    </div>
                                </div>
                            </div>
    ...
    <script id="no-facturados-template" type="text/x-handlebars-template">
        {{#each this}}
            <tr>
                <td>{{cod_orden}}</td>
                <td>{{fecha}}</td>
                ...
                <td class="text-center">
                    <ul class="table-controls">
                        <li>
                            ...
                            <a href="javascript:void(0);" class="bs-tooltip btnFacturar" data-id="{{cod_orden}}" data-toggle="tooltip" data-placement="top" data-original-title="Facturar">
