...
<body>
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-4 col-4 text-right">
                                    <button class="btn btn-primary" id="btnOpenModal">Nuevo Personal</button>
                                </div>
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <hr/>
                                </div>
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="style-3" class="table style-3 table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $resp = $Clpersonal->lista();
                                            foreach ($resp as $personal) {
                                                $imagen = $files.$personal['imagen'];
                                                $badge='primary';
                                                if($personal['estado'] == 'I')
                                                    $badge='danger';
                                                echo '<tr>
    ...
    <?php js_mandatory(); ?>
    <script src="assets/js/pages/personal.js?v=2" type="text/javascript"></script>
    <script>
        $('#style-3').DataTable( {
