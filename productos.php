                                ...
                                <table id="style-3" class="table style-3  table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($resp as $productos) {
                                                ...
                                                $btnIngrediente = "";
                                                if($permitIngredientes)    
                                                    $btnIngrediente = '<li><a href="producto_ingrediente.php?id='.$productos['alias'].'" target="_blank" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ingredientes"><i data-feather="coffee"></i></a></li>';
                                                echo '<tr>
