...
<body>
                ...
                <div class="layout-top-spacing">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <select class="form-control  basic" id="cmb_courier">
                                                    ...
                                                    $allDucursales = implode(',', $_sucursales);
                                                    $dataCouriers = $clsucursales->getCouriersIn($allDucursales);
                                                    $idsNotCouriers = [99];
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <table class="table style-3  table-hover table-couriers">
                                <thead>
                                    <tr>
                                        <th>Imagen</th>
                                        <th>Courier</th>
    ...
    <script id="table-sucursales-template" type="text/x-handlebars-template">
        {{#each this}}
            <tr>
                <td>
                    <img src="{{imagen}}" alt="" width="40">
                </td>
                <td>{{nombre}}</td>
                <td>{{pago}}</td>
                <td>${{decimal envio}}</td>
