...
<body>
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing bg-white">
                <div class="col-md-12" style="margin-top:25px; ">
                    ...
                    <h3 id="titulo">Reporte de envíos por motorizado</h3>
                </div>
                                ...
                                <table id="table-ordenes" class="table style-3">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Total</th>
                                            <th class="text-center">Num Envíos</th>
                                            <th class="text-center">Acciones</th>
                                        </tr>
                                    </thead>
                                    <tbody id="lstOrdenes">
    ...
    <?php js_mandatory(); ?>
    <script src="assets/js/pages/reporte_delivery.js?v=1" type="text/javascript"></script>
