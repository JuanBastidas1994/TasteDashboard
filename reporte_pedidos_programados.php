...
<body>
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing bg-white">
                <div class="col-md-12" style="margin-top:25px;">
                    ...
                    <h3 id="titulo">Reporte de pedidos programados</h3>
                </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12">
                            <div class="">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Productos a fabricar / despachar</h4>
                                </div>
    ...
    <?php js_mandatory(); ?>
    <script src="assets/js/pages/reporte_pedidos_programados.js?v=1" type="text/javascript"></script>
