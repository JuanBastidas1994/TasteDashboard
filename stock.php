...
<body>
    ...
    <div class="modal fade bs-example-modal-lg" id="crearModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Cerrar</button>
                    <button type="button" class="btn btn-primary" id="btnGuardarxx">Guardar</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    <div class="alert alert-arrow-right alert-icon-right alert-light-info mb-4" role="alert">
                        ...
                        Los productos sin SKU no pueden ser editados, para ir a agregar el SKU pulse Ir.
                    </div>

                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <form id="frmStock" name="frmStock">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="col-xl-4 col-md-4 col-sm-4 col-4 text-right">
                                        <select class="form-control" id="cmb_sucursales" name="cmb_sucursales">
                                            <?php
                                                echo'<option value="0">Escoja una sucursal</option>';
    ...
    <?php js_mandatory(); ?>
    <script src="assets/js/pages/stock.js" type="text/javascript"></script>
