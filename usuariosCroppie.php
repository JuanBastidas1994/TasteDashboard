...
<body>
                            ...
                            <div class="form-group">
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class="upload mt-1 pr-md-1">
                                        <input type="file" name="img_profile" id="dropify-profile" class="dropify" data-default-file="assets/img/200x200.jpg" data-max-file-size="1M" />
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 input-group" style="margin-bottom:10px;">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <select name="cmbRol" id="cmbRol" class="form-control" required="required" placeholder="Notification" aria-label="notification" aria-describedby="basic-addon1">
                                            ...
                                            foreach ($resp as $rol) {
                                                if ($rol['cod_rol'] == 4 || $rol['cod_rol'] == 6)
                                                    continue;
 ...
 <div class="modal fade bs-example-modal-lg" id="modalCroppie" tabindex="99" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    ...
    <script src="assets/js/pages/usuariosCroppie.js?v=2" type="text/javascript"></script>
    <script>
        $('#style-3').DataTable({
