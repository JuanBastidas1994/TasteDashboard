...
<body>
    <div class="modal fade bs-example-modal-xl" id="modalCroppie" tabindex="99" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-xl" role="document" style="z-index: 9999999 !important;">
                              ...
                              <div class="x_content">   
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12" style="margin-bottom:10px;">
                                        ...
                                        <select name="cmbAccion" class="form-control cmbAccion">
