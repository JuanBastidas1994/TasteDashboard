...
file_put_contents("logs/request.log", PHP_EOL . $mensaje, FILE_APPEND);
...
if (JSON_ERROR_NONE !== json_last_error()){
	...
	file_put_contents("logs/json-error.log", PHP_EOL . $return['mensaje']." ".$request, FILE_APPEND);
...
//     $return['success']= 0;
// 	$return['mensaje']= "El Json no es proporcionado por Uber Eats";
	
// 	file_put_contents("ubereats/json-no-ubereats.log", PHP_EOL . $return['mensaje']." ".$request, FILE_APPEND);
//     header("Content-type:application/json; charset=utf-8");
//     echo json_encode($return);
//     exit();
// } 
...
//         $estado = "ASIGNADA";
//         $Clordenes->asignarMotorizadoGacela($cod_orden, "Repartidor", "Uber Eats", "0999999999", "GGG-123", "https://dashboard.mie-commerce.com/assets/img/ubereats.png", "0999999999");
...
// file_put_contents("ubereats/".$Infostatus.".log", PHP_EOL . $mensaje, FILE_APPEND);
